...
def get_filters():
    """
    Asks user to specify a city, month, and day to analyze the bike system data. 
	...
	# HINT: Use a while loop to handle all the invalid inputs in the code.
    while True:
...
def load_data(city, month, day):
    """
    Loads data for the specified city and filters by month and day if applicable and specified by the user.
...
def time_stats(df):
    """Displays statistics on the most frequent times of travel which includes the common month,
	common day and common hour."""
